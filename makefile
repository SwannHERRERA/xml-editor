...
build: create_dir
	$(CC) $(EXTRAFLAG) -o $(BUILD_DIR)executable.out $(SRC)file_helper.c $(SRC)xml_element.c $(SRC)parse_dtd.c $(SRC)parse_xml.c $(SRC)check_xml_corresponding.c $(SRC)main.c $(LIB)
start:
